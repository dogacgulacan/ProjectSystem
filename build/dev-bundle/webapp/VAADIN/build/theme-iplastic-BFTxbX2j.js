...
`}),ace.define("ace/theme/iplastic",["require","exports","module","ace/theme/iplastic.css","ace/lib/dom"],function(a,e,c){e.isDark=!1,e.cssClass="ace-iplastic",e.cssText=a("./iplastic.css");var A=a("../lib/dom");A.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/iplastic"],function(a){n&&(n.exports=a)})}()})(i);var o=i.exports;const s=r(o),g=l({__proto__:null,default:s},[o]);export{g as t};
