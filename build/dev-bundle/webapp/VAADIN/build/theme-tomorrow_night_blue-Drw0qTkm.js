import{g as l}from"./_commonjsHelpers-Cpj98o6Y.js";function g(r,a){for(var o=0;o<a.length;o++){const e=a[o];if(typeof e!="string"&&!Array.isArray(e)){for(const n in e)if(n!=="default"&&!(n in r)){const t=Object.getOwnPropertyDescriptor(e,n);t&&Object.defineProperty(r,n,t.get?t:{enumerable:!0,get:()=>e[n]})}}}return Object.freeze(Object.defineProperty(r,Symbol.toStringTag,{value:"Module"}))}var c={exports:{}};(function(r,a){ace.define("ace/theme/tomorrow_night_blue.css",["require","exports","module"],function(o,e,n){n.exports=`.ace-tomorrow-night-blue .ace_gutter {
  background: #00204b;
  color: #7388b5
}
...
`}),ace.define("ace/theme/tomorrow_night_blue",["require","exports","module","ace/theme/tomorrow_night_blue.css","ace/lib/dom"],function(o,e,n){e.isDark=!0,e.cssClass="ace-tomorrow-night-blue",e.cssText=o("./tomorrow_night_blue.css");var t=o("../lib/dom");t.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/tomorrow_night_blue"],function(o){r&&(r.exports=o)})}()})(c);var i=c.exports;const u=l(i),_=g({__proto__:null,default:u},[i]);export{_ as t};
