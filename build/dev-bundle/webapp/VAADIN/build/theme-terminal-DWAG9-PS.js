...
`}),ace.define("ace/theme/terminal",["require","exports","module","ace/theme/terminal.css","ace/lib/dom"],function(a,e,n){e.isDark=!0,e.cssClass="ace-terminal-theme",e.cssText=a("./terminal.css");var c=a("../lib/dom");c.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/terminal"],function(a){t&&(t.exports=a)})}()})(m);var o=m.exports;const _=l(o),A=i({__proto__:null,default:_},[o]);export{A as t};
