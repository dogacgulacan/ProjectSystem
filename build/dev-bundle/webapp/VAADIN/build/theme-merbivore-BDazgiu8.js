...
`}),ace.define("ace/theme/merbivore",["require","exports","module","ace/theme/merbivore.css","ace/lib/dom"],function(r,e,n){e.isDark=!0,e.cssClass="ace-merbivore",e.cssText=r("./merbivore.css");var c=r("../lib/dom");c.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/merbivore"],function(r){a&&(a.exports=r)})}()})(t);var i=t.exports;const s=m(i),_=b({__proto__:null,default:s},[i]);export{_ as t};
